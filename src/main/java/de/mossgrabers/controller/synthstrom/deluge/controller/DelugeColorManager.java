 ...
 * Deluge uses RGB colors via SysEx or velocity-based palette colors via Note messages.
 *
...
public class DelugeColorManager extends ColorManager
{
    ...
    public static final int DELUGE_COLOR_MAGENTA         = 100;
    /** ID for color white. */
    ...
    public DelugeColorManager ()
    {
        ...
        this.registerColorIndex (Scales.SCALE_COLOR_OCTAVE, DELUGE_COLOR_CYAN);
        this.registerColorIndex (Scales.SCALE_COLOR_NOTE, DELUGE_COLOR_WHITE);
